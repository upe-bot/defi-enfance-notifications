      ...
      for (const p of eligibles) {
        ...
        if (typeId === 1) {
          ...
          if (coureurParraine) {
            ...
            const chefPrenom = structure ? (structure.prenom_du_referent_defi_enfance || structure.nom_du_referent_defi_enfance?.split(' ')[0] || 'Bonjour') : 'Bonjour';
            if (chefEmail) {
              const html = tplDonEquipe({ chefPrenom, chefNom, nomEquipe: 'Défi Enfance', donateur, montant, email_donateur: emailDon });
