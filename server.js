...
function tplGroupeJ1Angers({ prenom, numeroDossard, urlPageCoureur, urlPromesseCoureur }) {
  ...
  const blocDossard = numeroDossard
    ? `<div style="background:linear-gradient(135deg,#fff0f8,#fff5ef);border:2px solid #fb0089;border-radius:14px;padding:16px 22px;margin-bottom:20px;text-align:center"><div style="font-size:.72rem;font-weight:700;color:#fb0089;text-transform:uppercase;letter-spacing:.08em;margin-bottom:6px">&#127965;&#65039; Votre num&eacute;ro de dossard</div><div style="font-family:Arial,sans-serif;font-size:3rem;color:#fb0089;font-weight:700;line-height:1">${numeroDossard}</div><div style="font-size:.75rem;color:#3d1830;margin-top:6px">A r&eacute;cup&eacute;rer sur place d&egrave;s 8h30</div><div style="margin-top:14px"><a href="https://upe-bot.github.io/defi-enfance-dossard/index.html" style="display:inline-block;background:linear-gradient(135deg,#fb0089,#ef6135);color:#fff!important;text-decoration:none;padding:9px 20px;border-radius:99px;font-weight:700;font-size:.78rem">&#127965; Je retrouve mon dossard</a></div></div>`
    : `<div style="text-align:center;margin-bottom:20px"><a href="https://upe-bot.github.io/defi-enfance-dossard/index.html" style="display:inline-block;background:linear-gradient(135deg,#fb0089,#ef6135);color:#fff!important;text-decoration:none;padding:11px 24px;border-radius:99px;font-weight:700;font-size:.84rem">&#127965; Je retrouve mon dossard</a></div>`;
