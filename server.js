      ...
      while (true) {
        ...
        for (const p of items) {
          ...
          const numeroDossard = (dossardRaw !== null && dossardRaw !== undefined && dossardRaw !== '' && dossardRaw !== 0 && dossardRaw !== '0')
            ? String(dossardRaw)
            : '';
          // Filtrer : garder uniquement les coureurs avec un dossard dans la liste officielle
          const cfContact2 = contact.custom_fields || contact;
          const dossardNum = parseInt(cfContact2.numero_dossard_angers_2026 || contact.numero_dossard_angers_2026 || 0);
          if (!dossardNum || !DOSSARDS_ANGERS_2026.has(dossardNum)) continue; // pas de dossard ou dossard non officiel → skip
